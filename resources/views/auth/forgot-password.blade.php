    ...
    <form class="card card-md" action="{{ route('login.post') }}" method="post" autocomplete="off">
        ...
        <div class="card-body flex flex-col">
            ...
            <div class="mb-3 flex flex-col space-y-3">
                ...
                <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn bg-my_secondary border-[1px] rounded-md px-5 py-2" type="submit">Submit</button>
