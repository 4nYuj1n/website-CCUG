...
<div class="bg-my_secondary pb-10 pt-5 px-36 rounded-3xl shadow-black shadow-lg">
    ...
    <form class="card card-md" action="{{ route('register.post') }}" method="post" autocomplete="off">
        ...
        <div class="mt-3 flex flex-row justify-between">
            ...
            <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn bg-my_secondary border-[1px] rounded-md px-5 p-2" type="submit">Register</button>
        </div>
    </form>
</div>
</div>
