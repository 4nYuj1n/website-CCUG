    ...
    <form class="card card-md form-control" action="{{ route('login.post') }}" method="post" autocomplete="off">
        ...
        <div class="card-body flex flex-col">
            ...
            <div class="mb-3 flex flex-col space-y-2">
                ...
                <input type="email" name="email" value="" class="form-control @error('email') is-invalid @enderror w-80 rounded-lg h-9 bg-gray-300" placeholder="Email" required autofocus tabindex="1">
            </div>
            ...
            <div class="mb-3 flex flex-col">
                ...
                <input type="password" name="password" class="mb-2 form-control w-80 rounded-lg h-9 bg-gray-200" placeholder="Password" required tabindex="2">
            </div>
        </div>
